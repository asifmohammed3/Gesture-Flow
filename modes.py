...
#                     if thumb_up and time.time() - last_mode_change_time > 1:  # Check if 2 seconds have passed
...
#             if time.time() - last_mode_change_time < 0.5:  # Display mode activation for 0.5 seconds
